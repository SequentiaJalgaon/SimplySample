                ...
                <div class="col-12">
                  <div class="card mb-6">
                    <div class="user-profile-header-banner">
                      <img id="viewBrandLogoBanner" src="assets/img/pages/profile-banner.png" alt="Banner image" class="rounded-top" />
                    </div>
                      ...
                      <div class="flex-grow-1 mt-4 mt-sm-12">
                        <div
                          ...
                          <div class="user-profile-info">
                            <h4 class="mb-2" id="viewBrandBusinessName">John Doe</h4>
                            Registration Year: <span id="viewBrandRegisterYear" class="fw-medium"> Joined April 2021</span>
                            <!-- <ul
                              class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4">
                                <li class="list-inline-item">
                                    <span id="viewBrandFirstName" class="fw-medium">UX Designer</span>
                                    <span id="viewBrandLastName" class="fw-medium">UX Designer</span>
                                </li>
                                <li class="list-inline-item">
                                    <span id="viewBrandEmail" class="fw-medium">UX Designer</span>
                                </li>
                                <li class="list-inline-item">
                                    <span id="viewBrandContact" class="fw-medium"> Joined April 2021</span>
                                </li>
                                <li class="list-inline-item">
                                    <span id="viewBrandRegisterYear" class="fw-medium"> Joined April 2021</span>
                                </li>
                            </ul> -->
                          </div>
                    ...
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
                      <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"
                          ><i class="ri-user-3-line me-2"></i>Profile</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="pages-profile-teams.html"><i class="ri-team-line me-2"></i>Teams</a>
                      </li>
                      <li class="nav-item">
                ...
                <div class="col-xl-4 col-lg-5 col-md-5">
                    ...
                    <div class="card mb-6">
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            ...
                            <i class="ri-user-3-line ri-24px"></i><span class="fw-medium mx-2">Full Name:</span>
                                <span id="viewBrandFirstName" class="me-2"></span> 
                                <span id="viewBrandLastName"></span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                            <i class="ri-check-line ri-24px"></i><span class="fw-medium mx-2">Status:</span>
                            <span id="viewBrandStatus"></span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                            <i class="ri-star-smile-line ri-24px"></i><span class="fw-medium mx-2">GST Number:</span>
                            <span id="viewBrandGST"></span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                            <i class="ri-flag-2-line ri-24px"></i><span class="fw-medium mx-2">Food License Number:</span>
                            <span id="viewBrandFoodLicense">Food License Number</span>
                            </li>
                        </ul>
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            ...
                            <span id="viewBrandContact">(123) 456-7890</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                            <i class="ri-mail-open-line ri-24px"></i><span class="fw-medium mx-2">Email:</span>
                            <span id="viewBrandEmail">john.doe@example.com</span>
                            </li>
                        </ul>
                    ...
                    <div class="card card-action mb-6">
                        <div class="card-header align-items-center">
                          <h5 class="card-action-title mb-0">Provided Categories</h5>
                        ...
                        <div class="card-body">
                          <ul class="list-unstyled mb-0" id="categoriesShow">
                            <li class="mb-4">
                ...
                <div class="col-xl-8 col-lg-7 col-md-7">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-products table mt-5">
                            <thead>
                            <tr>
                                <!-- <th></th> -->
                                <!-- <th></th> -->
