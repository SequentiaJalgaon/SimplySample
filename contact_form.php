...
<html
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <div class="card-datatable table-responsive">
                  <h3 style="font-size: 20px; font-weight: bold;margin-bottom: 0px;color: #333;text-align: left;padding-left: 18px;margin-top: 17px;">View Enquiries</h3>
                  <table class="table datatables-contact">
                      <thead>
                          <tr>
                              <th>ID</th>
                              <th>Name</th>
    ...
    <script src="assets/js/app-ecommerce-contact_form.js"></script>
