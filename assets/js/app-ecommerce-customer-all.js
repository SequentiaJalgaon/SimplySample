              ...
              columnDefs: [
                ...
                
                {
                  ...
                  render: function (data, type, full, meta) {
                    ...
                    // return '<h6 class="mb-0">' + $contact + '</h6>';
                  }
                },
                {
                  // Actions
                  ...
                  render: function (data, type, full, meta) {
                    return (
                      ...
                      '<a href="user_order_history.php" class="btn btn-sm btn-icon btn-text-success waves-effect waves-light rounded-pill"><i class="ri-eye-line ri-20px"></i></a>' +
