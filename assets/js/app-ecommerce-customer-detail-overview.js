            ...
            columnDefs: [
              ...
              },
              {
                ...
                render: function (data, type, full, meta) {
                  ...
                  // return '<span class="badge text-heading rounded-pill">' + $status + '</span>';
                }
              },
              {
                // spent
              ...
              },
              {
                ...
                render: function (data, type, full, meta) {
                  return (
                    ...
                    '<a href="user_order_history-details" class="dropdown-item btn-text-success waves-effect waves-light rounded-pill"><i class="ri-eye-line ri-20px"></i></a>' +
