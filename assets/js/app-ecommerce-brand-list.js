      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return "<div class='text-sm-start'>" + $email + '</div>';
          }
        },
        {
          // Total Earnings
          ...
          render: function (data, type, full, meta) {
            ...
            return "<div class='text-sm-start'>" + $contact + '</div>';
          }
        },
        {
          // Total Earnings
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<button class="btn btn-sm rounded-pill btn-label-success waves-effect"><span class="tf-icons ri-check-double-line ri-16px me-2"></span>Onboard</button>' +
              '&nbsp;&nbsp;'+
