...
$(function () {
  ...
  var dt_product_table = $('.datatables-products'),
    ...
    //   1: { title: 'Active', class: 'bg-label-warning' },
...
function productStatusUpdate(productId, is_active = 0) {
 
  let action = 'deactive';
  if(is_active == 1) action = 'active';
  ...
  promise1
    ...
    .then(data => {
      ...
      if (typeof data.status !== 'undefined' && data.status == 'success') {
          ...
          document.querySelector('#entityTitle').innerHTML = data.title;
...
function featuredProduct(productId, is_featured = 0) {
