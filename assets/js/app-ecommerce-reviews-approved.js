        ...
        if (dt_customer_review.length) {
          var dt_review = dt_customer_review.DataTable({
            ...
            columnDefs: [
              ...
              //         '<button class="btn btn-sm btn-icon btn-text-success waves-effect waves-light rounded-pill"><i class="ri-check-line ri-20px"></i></button>' +
              //         '<button class="btn btn-sm btn-icon btn-text-danger waves-effect waves-light rounded-pill"><i class="ri-close-line ri-20px"></i></button>' +
              //       '</div>'
              //     );
              //   }
              // }
